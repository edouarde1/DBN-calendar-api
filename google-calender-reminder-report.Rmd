...
author: "Edouard Eltherington and Veronica Jack"
date: "12/12/2021"
output:
...
Lastly, this model relies on users being consistent with their reminders. Users might not always mark their events as a priority or might forget to include travel destination time. One idea would be to include some advanced text analysis technique that could read event name’s and automatically class events to priority or needing travel time. This would reduce the reliance on the user and create better predictions for event reminders. 
